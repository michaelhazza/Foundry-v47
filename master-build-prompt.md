...
## Version Reference
- **This Document**: master-build-prompt.md v43
- **Linked Documents**:
...
\-- scripts/
    ...
    \-- verify-*.sh (27 files)      <- Extracted from gate-scripts-reference.md
```
...
Phase 0: Extract Gate Scripts (Step 0 - MANDATORY FIRST STEP)
  ...
  |-- Verify: ls scripts/*.sh | wc -l (should equal 28)
  |-- Creates scripts/run-all-gates.sh + 27 verify-*.sh scripts
  |
  v
...
- [OK] Script counts: 28 total (1 orchestrator + 27 verification)
